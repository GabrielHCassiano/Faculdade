...
public class Grafo {
    ...
    public void adicionarVertice(Vertice... vertice) {
    	for (Vertice v : vertice) {
	        if (v == null) System.out.println("Vértice nulo não pode ser adicionado!");
	        else if (vertices.contains(v)) System.out.println("Vértice " + v.getNome() + " já existe!");
	        else if (v.getNome().isEmpty()) System.out.println("Vértice sem nome não pode ser adicionado!");
	        else {
	            vertices.add(v);
	            ordem++;
	            System.out.println("Vértice " + v.getNome() + " adicionado com sucesso!");
	        }
    	}
    }
    ...
    public void verificaAdjacencias() {
        ...
        if (this.eDirecionado) {
            for (Aresta aresta : arestas) {
                ...
                if (destino.getNome() != origem.getNome()) {
                ...
                //matrizIncidencia[2][0] = 1
                	...
                	matrizIncidencia[verticesIndices.get(destino.getNome())][aux] = 2;
